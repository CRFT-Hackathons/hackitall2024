          ...
          <div className="flex items-center">
            ...
            <div className="relative ml-4 hidden sm:block">
              <Input
                type="text"
                placeholder="Search"
                className="hidden sm:block pl-10 pr-4 py-5 border-none  bg-muted-background text-foreground rounded-md focus:ring-ring focus:border-ring w-full sm:text-sm shadow-none dark:bg-white/5 bg-black/5"
                value={searchQuery}
...
function NavItem({
  ...
  return (
    <Link
      href={href}
      className={
        `px-3 py-2 text-sm font-medium text-muted-foreground hover:text-black dark:hover:text-white focus:text-foreground` +
        (isActive
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="ml-4 flex flex-col items-center text-sm font-medium text-muted-foreground hover:text-foreground focus: focus:text-foreground focus:bg-transparent">
